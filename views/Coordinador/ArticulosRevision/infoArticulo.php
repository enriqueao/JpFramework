...
<div id="articuloEval">
    ...
    <div id="opciones2">
       <a class="infoFile option" href="<?=URL.'public/VVBMT0FE/YXJjaGl2b3M/'.$this->articulo['archivo']?>" target="_blank">
        ...
        <?php if($this->articulo['idUsuario'] === Session::getValue('idUsuario') && ($this->articulo['descripcion'] != 'Rechazado') && ($this->articulo['descripcion'] == 'Aceptado con cambios menores' || $this->articulo['descripcion'] == 'Aceptado con cambios mayores')){ ?>
