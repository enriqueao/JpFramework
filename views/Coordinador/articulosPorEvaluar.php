...
<div id="barraOpciones">
    ...
    <select id="filtro" required name="buscar" onchange="setFiltro()">
        ...
        <option value="art.titulo">Titulo</option>
        <option value="cat.nombreCategoria">Categoria</option>
        <option value="sta.descripcion">Estatus</option>
        <option value="art.fecha">Fecha</option>
    </select>
     ...
     <table id="myTable">
      <tr>
        ...
        <?php foreach($this->articulos as $columna => $valor){?>
          <?php if(true){ ?>
            <tr onclick="generarPrevio('Investigador', 'evaluadorArticulo',<?=$valor['idArticulo']?>)">
