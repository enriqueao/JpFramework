...
<div id="articuloEval">
    ...
    <h3 class="commTitulo">Evaluaciones</h3>
    <table id="evaluaciones">
        ...
        <tr>
            <td><b>Originalidad</b></td>
            <td><?=$this->getCriterios[0]['originalidadesc']?></td>
            <td><?=$this->getCriterios[1]['originalidadesc']?></td>
        </tr>
        <tr>
            <td><b>Lenguaje</b></td>
            <td><?=$this->getCriterios[0]['lenguajedesc']?></td>
            <td><?=$this->getCriterios[1]['lenguajedesc']?></td>
        </tr>
        <tr>
            <td><b>Claridad</b></td>
            <td><?=$this->getCriterios[0]['claridaddesc']?></td>
            <td><?=$this->getCriterios[1]['claridaddesc']?></td>
        </tr>
        <tr>
            <td><b>Contenido<br>Científico</b></td>
            <td><?=$this->getCriterios[0]['contenidodesc']?></td>
            <td><?=$this->getCriterios[1]['contenidodesc']?></td>
        </tr>
        </table>
    <!--<p class="criterio">Originalidad</p>
     <div class="radio-group dict">
       <label class="labelRadio"><?=$this->getCriterios[0]['originalidadesc']?></label>
       <label class="labelRadio"><?=$this->getCriterios[1]['originalidadesc']?></label>
     </div>
     <p class="criterio">Lenguaje</p>
     <div class="radio-group dict">
       <label class="labelRadio"><?=$this->getCriterios[0]['lenguajedesc']?></label>
       <label class="labelRadio"><?=$this->getCriterios[1]['lenguajedesc']?></label>
     </div>
     <p class="criterio">Claridad</p>
     <div class="radio-group dict">
       <label class="labelRadio"><?=$this->getCriterios[0]['claridaddesc']?></label>
       <label class="labelRadio"><?=$this->getCriterios[1]['claridaddesc']?></label>
     </div>
     <p class="criterio">Contenido científico</p>
     <div class="radio-group dict">
       <label class="labelRadio"><?=$this->getCriterios[0]['contenidodesc']?></label>
       <label class="labelRadio"><?=$this->getCriterios[1]['contenidodesc']?></label>
     </div>-->
     
    <h3 class="commTitulo">Dictamen</h3>
    <p class="criterio">Originalidad</p>
    ...
    <textarea id="comentario" class="comentario" onkeypress="counter()" onchange="counter()" onkeydown="counter()" onkeyup="counter()" maxlength="150"></textarea>
    <div id="counter">0 / 150</div>
    <h3 class="commTitulo">Dictamen del articulo</h3>
    <select name="" id="estado">
        <?=$this->statusArt?>
    </select>
    
    <div id="opciones2">
        <div class="option" onclick="dictaminar()">
            <div class="icon"><i class="fa fa-gavel fa-lg" aria-hidden="true"></i></div>
            <a class="infoFile"><div class="infoFile">Dictaminar</div></a>
        </div>
    </div>
</div>
