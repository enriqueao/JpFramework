<h2 class=tituloCat>Nuevo Evaluador</h2>
<label class="div10 labelNuevoEval" for="correo">Correo</label>
<input id="correoRegistroe" class="div10" type="text" name="correo" placeholder="algo@example.com*" onblur="validateMail(this)" onchange="comprobarRegistro(event)" autocomplete="off">
<label class="div10 labelNuevoEval" for="confCorreo">Confirmar correo</label>
<input id="confCorreoRegistroe" class="div10 animated" type="text" name="confCorreo" placeholder="algo@example.com*" onblur="validateMail(this)" onchange="comprobarRegistro(event)" oninput="comprobarRegistro(event)" autocomplete="off">
...
<button id="btnRegistrar" onclick="registrar()">Agregar</button>
