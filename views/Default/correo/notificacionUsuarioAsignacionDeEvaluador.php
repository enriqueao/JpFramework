                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td style="padding: 30px 10px 30px 10px;">
                            Tu Artículo ha sido asignado a un Evaluador para ser evalaudo y calificado, te avisaremos de algún cambio de estado.
                            <br><br>
                            <a href="<?=URL?>" style="cursor:pointer;">Ver</a>
                            <br><br>
