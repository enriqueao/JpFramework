...
<head>
    ...
    <title>Invitación Evaluador Plataforma Investigadores</title>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td style="padding: 10px; border-bottom: 1px solid rgba(0, 0, 0, 0.2);">
                            <h2>Hola, <?=strtoupper($data['nombreCompleto'])?></h2>
                        </td>
                    </tr>
                    <br><br><br>
                    <tr>
                        <td style="padding: 30px 10px 30px 10px;">
                            Da clic al siguiente enlace para accesar al sistema y establecer tu contraseña:
                            <br><br>
                            <a href="<?=URL.'Solicitud/establecerContrasena/'.$data['clv']?>" style="cursor:pointer;">Establecer Contraseña</a>
                            <br><br>
                            Este enlace caducará en 24 horas.
                            <br><br>
                            No has solicitado un cambio de contraseña haznos saber.
                            <br><br>
                            <a href="<?=URL.'Solicitud/cancelarSolicitud/'.$data['clv']?>" style="cursor:pointer;">No he sido yo.</a>
                            <br><br>
                            Este enlace caducará en 24 horas.
